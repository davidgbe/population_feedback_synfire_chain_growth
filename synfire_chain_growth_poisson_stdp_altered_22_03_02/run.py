...
M = Generic(
    ...
    W_E_E_R_MIN=1e-6,
    W_E_E_R_MAX=0.26 * 0.004 * 1.3 * 0.2, #1.5, then 1, then 0.2;
...
def run_test(m, output_dir_name, n_show_only=None, add_noise=True, dropouts={'E': 0, 'I': 0},
    ...
    for i_e in range(epochs):
        ...
        if i_e > 0:
            ...
            w_r_copy['E'][:m.N_EXC, :m.N_EXC] += ((firing_rate_potentiation + stdp_ee_potentiation + stdp_ee_depression)  * w_r_copy['E'][:(m.N_EXC + m.N_SILENT), :(m.N_EXC + m.N_SILENT)])
